...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">Committee Member List</h5>
        <a href="{{ route('committee-members.create') }}" class="btn btn-primary btn-sm">
...
$(function () {
    let table = $('#responsive-datatable').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{ route("committee-members.index") }}',
        columns: [
    ...
    $(document).on('submit', '.delete-form', function (e) {
        ...
        const url = '{{ route("committee-members.destroy", ":id") }}'.replace(':id', id);
