                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12 mb-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm" required name="title_bn" placeholder="Title">
                                @error('title_bn')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6 col-12 mb-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm" required name="title_en" placeholder="Title">
                                @error('title_en')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12 col-12 mb-2">
                            <div class="mb-4">
                               ...
                               <input type="file" class="form-control form-control-sm" required name="file_name" placeholder="Display name">
                                @error('file_name')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-12 col-12 mb-2">
                            <div class="mb-4">
                               ...
                               <input type="text" class="form-control form-control-sm" required name="file_display_name" placeholder="Display name">
