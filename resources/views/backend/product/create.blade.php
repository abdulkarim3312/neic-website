                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-12 mb-7">
                            ...
                            <input type="file" id="feature_image" name="feature_image" required accept="image/*" class="form-control form-control-sm mb-2">

                            <div id="feature-preview-area" class="mt-2"></div>
                        </div>
                        <div class="mb-4">
                            <label for="image" class="form-label fw-medium">Gallery Images</label>
                            <input type="file" id="image" name="images[]" accept="image/*" multiple class="form-control form-control-sm mb-2">
                            
                            <!-- Image preview area -->
                            <div id="image-preview-area" class="d-flex flex-wrap gap-2"></div>
                        </div>
                        <div class="col-md-12 col-12">
                            <div class="mb-3">
                                <label for="nameInput" class="form-label">Short Description</label>
                                <textarea name="short_description" id="" required class="form-control form-control-sm" rows="4"></textarea>
                            </div>
                        </div>
                        <div class="col-md-12 col-12">
                            <div class="mb-3">
                        ...
                        <div class="col-md-12 col-12 mb-2">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control form-control-sm" required name="product_tag" placeholder="tags">
                            </div>
                        </div>
                        <div class="col-md-12 col-12 mb-2">
                            <div class="mb-3">
                                <label for="nameInput" class="form-label">Meta Keywords</label>
                                <input type="text" class="form-control form-control-sm" required name="meta_keywords" placeholder="Meta keywords">
                            </div>
                        </div>
                        <div class="col-md-12 col-12">
                            <div class="mb-3">
                                <label for="nameInput" class="form-label">Meta Description</label>
                                <textarea name="meta_description" id="" required class="form-control form-control-sm" rows="4" placeholder="Enter meta description"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <input type="number" class="form-control" required name="cost_price" placeholder="Enter Previous Price">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-sm">
                            <span class="input-group-text">৳</span>
                                <input type="number" class="form-control" required name="sale_price" placeholder="Enter Current Price">
                        </div>
                    </div>
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-sm">
                            <span class="input-group-text">%</span>
                                <input type="number" class="form-control" required name="discount_price" id="discount" placeholder="Enter Discount Price">
                        </div>
                    </div>
                    <div class="mb-4">
                        <label class="form-label fw-medium">Category <span class="text-danger">*</span></label>
                        <select class="form-select form-select-sm" required name="category_id" id="categorySelect">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select form-select-sm" required name="sub_category_id" id="subcategorySelect">
                            <option value="">--Select--</option>
                        </select>
                    </div>
                    <div class="mb-4">
                        <label class="form-label fw-medium">Child Category</label>
                        <select class="form-select form-select-sm" required name="child_category_id" id="childCategorySelect">
                            <option value="">--Select--</option>
                        </select>
                    </div>
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group input-group-sm">
                            <input type="number" class="form-control" required name="total_stock" placeholder="Total Stock">
                        </div>
                    </div>
                    <div class="mb-4">
                        <label class="form-label fw-medium">Video Link</label>
                        <div class="input-group input-group-sm">
                            <input type="text" class="form-control" required name="video_link" placeholder="Enter Video Link">
                        </div>
                    </div>
                    <div class="mb-4">
...
$(document).ready(function () {
    ...
    $('#image').on('change', function (e) {
        ...
        $('#image-preview-area').empty(); // Clear previous previews
        ...
        files.forEach((file, index) => {
            ...
            reader.onload = function (event) {
                ...
                `;
                $('#image-preview-area').append(imgHtml);
            };
