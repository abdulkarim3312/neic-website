...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h5 class="card-title mb-0">Article Category List</h5>
...
$(function () {
    ...
    $(document).on('submit', '.delete-form', function (e) {
        ...
        const url = '{{ route("article-categories.destroy", ":id") }}'.replace(':id', id);
    ...
    $(document).on('change', '.status-toggle', function () {
        ...
        const url = '{{ route("article_category_status", ":id") }}'.replace(':id', id);
