! function(e, t) {
					...
					e.exports = function(e) {
						...
						return t.toString = function() {
							return this.map((function(t) {
								var o = "",
									i = void 0 !== t[5];
								return t[4] && (o += "@supports (".concat(t[4], ") {")), t[2] && (o += "@media ".concat(t[2], " {")), i && (o += "@layer".concat(t[5].length > 0 ? " ".concat(t[5]) : "", " {")), o += e(t), i && (o += "}"), t[2] && (o += "}"), t[4] && (o += "}"), o
							})).join("")
							...
							for (var c = 0; c < e.length; c++) {
								var u = [].concat(e[c]);
								i && s[u[0]] || (void 0 !== a && (void 0 === u[5] || (u[1] = "@layer".concat(u[5].length > 0 ? " ".concat(u[5]) : "", " {").concat(u[1], "}")), u[5] = a), o && (u[2] ? (u[1] = "@media ".concat(u[2], " {").concat(u[1], "}"), u[2] = o) : u[2] = o), n && (u[4] ? (u[1] = "@supports (".concat(u[4], ") {").concat(u[1], "}"), u[4] = n) : u[4] = "".concat(n)), t.push(u))
							}
						}, t
					}
				},
					...
					return t = e, o = [{
						...
						value: function(e) {
							...
							if (this._hasControls("skins")) {
								...
								o && (this.settings.skin = o, t && this._setSetting("Skin", e), t && this.settings.onSettingsChange.call(this, this.settings))
							}
						}
					}, {
						...
						value: function(e) {
							var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
							this._hasControls("layoutNavbarOptions") && (this.settings.layoutNavbarOptions = e, t && this._setSetting("FixedNavbarOption", e), window.Helpers.setNavbar(e), t && this.settings.onSettingsChange.call(this, this.settings))
						}
					}, {
						key: "setContentLayout",
						value: function(e) {
							var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
							this._hasControls("contentLayout") && (this.settings.contentLayout = e, t && this._setSetting("contentLayout", e), window.Helpers.setContentLayout(e), t && this.settings.onSettingsChange.call(this, this.settings))
						}
					}, {
						key: "setHeaderType",
						value: function(e) {
							var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
							if (this._hasControls("headerType") && ["static", "static-offcanvas", "fixed", "fixed-offcanvas"].includes(e)) {
								this.settings.headerType = e, t && this._setSetting("HeaderType", e), window.Helpers.setPosition("fixed" === e || "fixed-offcanvas" === e, "static-offcanvas" === e || "fixed-offcanvas" === e), t && this.settings.onSettingsChange.call(this, this.settings);
						...
						value: function(e) {
							var t = !(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1];
							this.settings.layoutFooterFixed = e, t && this._setSetting("FixedFooter", e), window.Helpers.setFooterFixed(e), t && this.settings.onSettingsChange.call(this, this.settings)
						}
					}, {
						...
						value: function(e) {
							...
							if (this._hasControls("showDropdownOnHover")) {
								if (this.settings.showDropdownOnHover = e, t && this._setSetting("ShowDropdownOnHover", e), window.Helpers.mainMenu) {
									window.Helpers.mainMenu.destroy(), config.showDropdownOnHover = e;
									var o = window.Menu;
								...
								t && this.settings.onSettingsChange.call(this, this.settings)
							}
						}
					}, {
						key: "setRtl",
						value: function(e) {
							this._hasControls("rtl") && this._setSetting("Rtl", String(e))
						}
					}, {
						key: "setLang",
						value: function(t) {
							...
							if (t !== this.settings.lang || n) {
								if (!e.LANGUAGES[t]) throw new Error('Language "'.concat(t, '" not found!'));
								var a = e.LANGUAGES[t];
								["panel_header", "panel_sub_header", "theming_header", "color_label", "theme_label", "style_switch_light", "style_switch_dark", "layout_header", "layout_label", "layout_header_label", "content_label", "layout_static", "layout_offcanvas", "layout_fixed", "layout_fixed_offcanvas", "layout_dd_open_label", "layout_navbar_label", "layout_footer_label", "misc_header", "skin_label", "semiDark_label", "direction_label"].forEach((function(e) {
									var t = o.container.querySelector(".template-customizer-t-".concat(e));
									t && (t.textContent = a[e])
								})), this.settings.lang = t, i && this._setSetting("Lang", t), i && this.settings.onSettingsChange.call(this, this.settings)
							}
						}
					}, {
						key: "update",
						...
						value: function() {
							if (!this._ssr) {
								...
								["Color", "Theme", "Skin", "SemiDark", "LayoutCollapsed", "FixedNavbarOption", "HeaderType", "contentLayout", "Rtl", "Lang"].forEach((function(t) {
    ...
    a.innerHTML = `
        <div class="form-check ${s} mb-0">
          <label class="form-check-label custom-option-content p-0" for="${o}${e}">
        ...
        <label class="form-check-label small text-nowrap text-body" for="${o}${e}">${t}</label>
    `;
    if (n) {
        a.querySelector(".custom-option-body").innerHTML = i;
    } else {
        fetch(`/lib/img/customizer/${i}`)
            .then(e => e.text())
            .then(e => {
                a.querySelector(".custom-option-body").innerHTML = e;
            })
            .catch(e => {
                // error handle করতে চাইলে এখানে লিখতে পারো
    ...
    return a;
							...
							var i = this.container.querySelector(".template-customizer-open-btn"),
								n = function() {
									e.container.classList.add("template-customizer-open"), e.update(), e._updateInterval && clearInterval(e._updateInterval), e._updateInterval = setInterval((function() {
										e.update()
									}), 500)
								};
							...
							var r = this.container.querySelector(".template-customizer-close-btn"),
								l = function() {
									e.container.classList.remove("template-customizer-open"), e._updateInterval && (clearInterval(e._updateInterval), e._updateInterval = null)
								};
							...
							if (this._hasControls("color")) {
								...
								var p = function(t) {
									"picker" === t.target.value ? document.querySelector(".custom-option-content .pcr-button").click() : (e._setSetting("Color", t.target.dataset.color), e.setColor(t.target.dataset.color, (function() {
										e._loadingState(!1)
									}), !0))
								};
							...
							if (this._hasControls("theme")) {
								this.settings.availableThemes.forEach((function(e) {
									var t = o(e.name, e.title, "customRadioIcon", e.image, !0);
									g.appendChild(t)
								...
								var v = function(t) {
									if (document.documentElement.setAttribute("data-bs-theme", t.target.value), e._hasControls("semiDark")) {
										var o = e.container.querySelector(".template-customizer-semiDark");
										"dark" === t.target.value ? o.classList.add("d-none") : o.classList.remove("d-none")
									}
									window.Helpers.syncThemeToggles(t.target.value), e.setTheme(t.target.value, !0, (function() {
										e._loadingState(!1)
									}))
								};
							...
							if (this._hasControls("skins")) {
								...
								var y = function(t) {
									document.documentElement.setAttribute("data-skin", t.target.value), e.setSkin(t.target.value, !0, (function() {
										e._loadingState(!1, !0)
									}))
								};
								...
								if (this._hasControls("semiDark") && "dark" === this._getSetting("Theme")) _.classList.add("d-none");
									...
									var S = function(t) {
										var o = t.target.checked,
											i = o ? "dark" : "light";
										"dark" === i ? (document.getElementById("layout-menu").setAttribute("data-bs-theme", i), document.documentElement.setAttribute("data-semidark-menu", "true")) : (document.getElementById("layout-menu").removeAttribute("data-bs-theme"), document.documentElement.removeAttribute("data-semidark-menu")), e._setSetting("SemiDark", o)
									};
							...
							if (this._hasControls("contentLayout headerType layoutCollapsed layoutNavbarOptions rtl", !0)) {
								...
								if (this._hasControls("layoutCollapsed")) {
									...
									this.settings.availableMenuCollapsed.forEach((function(e) {
									...
									var A = function(t) {
										window.Helpers.setCollapsed("collapsed" === t.target.value, !0), e._setSetting("LayoutCollapsed", "collapsed" === t.target.value)
									};
									x.addEventListener("change", A), this._listeners.push([x, "change", A])
								} else C.parentNode.removeChild(C);
								var E = this.container.querySelector(".template-customizer-content");
								if (this._hasControls("contentLayout")) {
									var L = E.querySelector(".template-customizer-content-options");
									this.settings.availableContentLayouts.forEach((function(e) {
										var t = o(e.name, e.title, "contentRadioIcon", e.image);
										L.appendChild(t)
									})), L.querySelector('input[value="'.concat(this.settings.contentLayout, '"]')).setAttribute("checked", "checked");
									var N = function(t) {
										e._loading = !0, e._loadingState(!0, !0), e.setContentLayout(t.target.value, !0, (function() {
											e._loading = !1, e._loadingState(!1, !0)
										}))
									};
									L.addEventListener("change", N), this._listeners.push([L, "change", N])
								...
								if (this._hasControls("headerType")) {
									...
									}), 100), this.settings.availableHeaderTypes.forEach((function(e) {
										var t = o(e.name, e.title, "headerRadioIcon", e.image);
										D.appendChild(t)
								...
								if (this._hasControls("layoutNavbarOptions")) {
									setTimeout((function() {
										O.includes("horizontal") && I.parentNode.removeChild(I)
									}), 100);
									var H = I.querySelector(".template-customizer-navbar-options");
									this.settings.availableNavbarOptions.forEach((function(e) {
										var t = o(e.name, e.title, "navbarOptionRadios", e.image);
										H.appendChild(t)
									})), H.querySelector('input[value="'.concat(this.settings.layoutNavbarOptions, '"]')).setAttribute("checked", "checked");
									var F = function(t) {
										e._loading = !0, e._loadingState(!0, !0), e.setLayoutNavbarOption(t.target.value, !0, (function() {
											e._loading = !1, e._loadingState(!1, !0)
										}))
									};
									H.addEventListener("change", F), this._listeners.push([H, "change", F])
								...
								if (this._hasControls("rtl")) {
									...
									this.settings.availableDirections.forEach((function(e) {
										var t = o(e.name, e.title, "directionRadioIcon", e.image);
										M.appendChild(t)
									})), M.querySelector('input[value="'.concat(this.settings.rtl ? "rtl" : "ltr", '"]')).setAttribute("checked", "checked");
									var R = function(t) {
										e._setSetting("Lang", e.settings.lang), e._setSetting("Lang", "ar" === e.settings.lang ? "en" : "ar"), e.settings.rtl = "rtl" === t.target.value;
										var o = e._getSetting("Lang"),
											i = document.querySelector(".dropdown-language .dropdown-menu");
										i && i.querySelector('[data-language="'.concat(o, '"]')).click(), e._initDirection(), e.setRtl("rtl" === t.target.value, !0, (function() {
											e._loadingState(!1)
										}))
									};
									M.addEventListener("change", R), this._listeners.push([M, "change", R])
								} else B.parentNode.removeChild(B)
							} else w.parentNode.removeChild(w);
							setTimeout((function() {
								var t = e.container.querySelector(".template-customizer-layout"),
									o = e.container.querySelector(".template-customizer-theming"),
									i = !1;
								"light" === document.documentElement.getAttribute("data-bs-theme") && document.querySelector(".layout-menu") && ("dark" === document.querySelector(".layout-menu").getAttribute("data-bs-theme") && (i = !0), !0 === i && o.querySelector(".template-customizer-semi-dark-switch").setAttribute("checked", "checked")), document.querySelector(".menu-vertical") ? e._hasControls("rtl contentLayout layoutCollapsed layoutNavbarOptions", !0) || t && t.parentNode.removeChild(t) : document.querySelector(".menu-horizontal") && (e._hasControls("rtl contentLayout headerType", !0) || t && t.parentNode.removeChild(t))
							}), 100), this.setLang(this.settings.lang, !1, !0), t === document ? t.body ? t.body.appendChild(this.container) : window.addEventListener("DOMContentLoaded", (function() {
						...
						key: "_loadingState",
						value: function(e, t) {
							this.container.classList[e ? "add" : "remove"]("template-customizer-loading".concat(t ? "-theme" : ""))
						}
					}, {
						...
						value: function(e, t) {
							...
							try {
								localStorage.setItem("templateCustomizer-".concat(o, "--").concat(e), String(t)), this._showResetBtnNotification()
							} catch (e) {}
						}
					}, {
						key: "_getSetting",
						value: function(e) {
							...
							try {
								t = localStorage.getItem("templateCustomizer-".concat(o, "--").concat(e))
							} catch (e) {}
							return String(t || "")
						}
					}, {
						...
						value: function() {
							...
							setTimeout((function() {
								var o = e.container.querySelector(".template-customizer-reset-btn .badge");
						...
						value: function() {
							for (var e = 0, t = this._listeners.length; e < t; e++) this._listeners[e][0].removeEventListener(this._listeners[e][1], this._listeners[e][2])
						}
					}, {
						key: "_cleanup",
						value: function() {
						...
						value: function(e) {
							...
							return e.split(" ").reduce((function(e, i) {
								return -1 !== t.settings.controls.indexOf(i) ? (o || !1 !== e) && (e = !0) : o && !0 === e || (e = !1), e
							}), null)
						}
					}, {
						key: "_getDefaultSkin",
						value: function(e) {
							var t = "string" == typeof e ? this._getSkinByName(e, !1) : this.settings.availableSkins[e];
							if (!t) throw new Error('Skin ID "'.concat(e, '" not found!'));
							return t
						}
					}, {
						key: "_getSkinByName",
						value: function(e) {
							for (var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1], o = this.settings.availableSkins, i = 0, n = o.length; i < n; i++)
								if (o[i].name === e) return o[i];
							return t ? this.settings.defaultSkin : null
						}
					}], o && b(t.prototype, o), i && b(t, i), Object.defineProperty(t, "prototype", {
						writable: !1
					}), e
				}();
			D.COLORS = [{
			...
			window.onload = function() {
				! function() {
					...
					if (e.pickerWrapper && e.pickerEl) {
						var t = "checked" === e.pickerWrapper.getAttribute("checked") ? window.templateCustomizer._getSetting("Color") ? window.templateCustomizer._getSetting("Color") : window.templateCustomizer.settings.defaultPrimaryColor : window.Helpers.getCssVar("gray-900", !0),
							o = new Pickr({
								el: e.pickerEl,
								theme: "nano",
								default: t,
						...
						o._root.button.classList.add("ri", "ri-palette-line"), o.on("change", (function(t) {
							var o, i = t.toHEXA().toString(),
								n = t.toRGBA().toString();
							null === (o = e.pcrButton) || void 0 === o || o.style.setProperty("--pcr-color", n), e.pickerWrapper.checked = !0, window.Helpers.updateCustomOptionCheck(e.pickerWrapper), window.templateCustomizer._setSetting("Color", i), window.templateCustomizer.setColor(i, !0)
						}))
					}
				}();
				var e = document.querySelector(".custom-option-content .pcr-button");
				null == e || e.style.setProperty("--pcr-color", window.templateCustomizer.settings.defaultPrimaryColor)
			}
		}(), i
	}()
}));
