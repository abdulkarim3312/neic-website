...
use Closure;
use Solveit\ProOptimization\Entities\HtmlSpecs;
use Symfony\Component\HttpFoundation\StreamedResponse;
use Symfony\Component\HttpFoundation\BinaryFileResponse;

abstract class ProOptimization
{
    ...
    protected function isEnable()
    {
        ...
        static::$isEnabled = (bool) config('pro-optimization.enable', true);
    ...
    protected function shouldProcessPageSpeed($request, $response)
    {
        ...
        $patterns = config('pro-optimization.skip', []);
